        ...
        <div id="container">
            ...
            <div class="workzone">
                <div class="workzone-left">
                    <div class="mydiv">
                        <h1>Add Company</h1>
                        <form action="addcompany_db.jsp" method="post">
                            <table>
                                <tr height="40px;"><td><label style="font: 18px sans-serif;color: #BF5A14;">Company Information</label></td></tr>
                                <tr><td>Company :</td><td><input type="text" name="cname" required/></td></tr>
                                <tr><td>Location :</td><td><textarea name="cloc" required></textarea></td></tr>
                                <tr><td>Contact No. :</td><td><input type="tel" name="cno" onkeypress="return isNumberKey(event)" required/></td></tr>
                                <tr><td>Email :</td><td><input type="email" name="cemid" required/></td></tr>
                                <tr height="40px;"><td><label style="font: 18px sans-serif;color: #BF5A14;">Company Head Information</label></td></tr>
