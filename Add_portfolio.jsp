...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
        function performAjaxSubmit() {
            ...
            xhr.open("POST", "insert_portfolio.jsp", true);
            xhr.send(formdata);
        ...
        <div id="container">
            ...
            <div class="workzone">
                <div class="workzone-left">
                    <div class="mydiv">
                        <h1>Add Portfolios</h1>
                        Portfolio :<input type="file" id="upldcvrpic"/>&nbsp;&nbsp;<input type="button" value="Upload" onclick="performAjaxSubmit()"/>
                    </div>
                    <div class="clear"></div>
                </div>
