...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
        function rmvfn(uid)
        {
            ...
            if (a === true)
            {
                window.location = "./user_approve_action.jsp?uid=" + uid + "&act=a";
            }
        }
        function appvfn(uid)
        {
            ...
            if (a === true)
            {
                window.location = "./user_approve_action.jsp?uid=" + uid + "&act=b";
            }
        }
    </script>
    <body>
                ...
                <div class="workzone-left">
                    <div class="mydiv" style="height: 380px;width:1024px;overflow: auto;">
                        ...
                        <table width="800">
                            ...
                            <%
                                ResultSet rs = new Validate().viewuser();
                                while (rs.next()) {%>
                            <tr height="40">
                                ...
                                <td><center><input type="button" value="Approve" onclick="appvfn('<%=rs.getString("id")%>')"/>&nbsp;&nbsp;<input type="button" value="Reject" onclick="rmvfn('<%=rs.getString("id")%>')"/></center></td>
                            </tr>
                            <%}%>
                        </table>
                    </div>
