...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    %>
    <script>
        function hirefn(agid)
        {
            window.location = "./hire_agency_action.jsp?agid=" + agid;
        }
    </script>
    <body>
        <div id="container">
            ...
            <div class="workzone">
                <div class="workzone-left">
                    <div id="prdiv">
                        <h1>Products</h1>
                        <input type="button" value="Hire Agency" onclick="hirefn('<%=agid%>')" style="margin-bottom: 10px;"/>
                        <%
                        ...
                        <div class="vwpr">
                            ...
                            <table style="position: relative;left: 220px;bottom: 170px;font: 14px sans-serif;">
                                <tr height="40"><td>Product Name :</td><td><label><%=rs.getString("pname")%></label></td></tr>
                                <tr height="40"><td>Product Category :</td><td><label><%=rs.getString("pcat")%></label></td></tr>
                                <tr height="40"><td>Price :</td><td><label><%=rs.getString("ppu")%></label></td></tr>
                                <tr height="40"><td>Stock :</td><td><label><%=rs.getString("pstock")%></label></td></tr>
                            </table>
                        </div>
                        <%}
                        %>
